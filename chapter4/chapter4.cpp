...
void exercise_23_score_system_v2_search_with_name();

void exercise_24_score_system_v3_search_with_score();
...
int main() {
    ...
    // exercise_23_score_system_v2_search_with_name();
    exercise_24_score_system_v3_search_with_score();
...
void exercise_24_score_system_v3_search_with_score() {
    ...
    cout << "**********************" << endl;
    cout << "******* Search *******" << endl;
    for(double student_score; cin >> student_score;) {
        bool is_exist = false;
        for(int index = 0; index < name_list.size(); ++index) {
            if(student_score == score_list.at(index)) {
                cout << "Result, name: " << student_score << ", score: " << score_list.at(index) << endl;
